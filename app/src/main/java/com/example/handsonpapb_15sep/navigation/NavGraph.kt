...
import com.example.handsonpapb_15sep.model.User
import com.example.handsonpapb_15sep.model.WasteItem
import com.example.handsonpapb_15sep.ui.screens.*
import com.example.handsonpapb_15sep.ui.screens.auth.*
...
fun SampahJujurNavGraph(
    ...
    NavHost(
        ...
        composable(Screen.HouseholdLogin.route) {
            HouseholdLoginScreen(
                onLoginClick = { email, password ->
                    // TODO: Handle login with Firebase
        ...
        composable(Screen.CollectorDashboard.route) {
            // TODO: Get from ViewModel
            val pendingRequests = emptyList<PickupRequest>()
            val myRequests = emptyList<PickupRequest>()
